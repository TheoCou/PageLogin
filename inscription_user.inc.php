<?php
    ...
    if (isset($_POST['mail']) || isset($_POST['psw'])) {
        ...
        if (!$_POST['mail'] || !$_POST['psw']) {
        ...
        } elseif (!filter_var($_email, FILTER_VALIDATE_EMAIL)) { //attention à ma fonction
            echo "<p class=\"warning\">Mail invalide</p>";
        } elseif (is_numeric($_email)) {
            ...
            echo "<p class=\"success\">Merci votre contenu est ajouté :<a href=\"log.php\" title=\"pub\">
            Connectez vous</a>
